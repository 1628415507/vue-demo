...
const devWebpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    new webpack.HotModuleReplacementPlugin(),//模块热替换插件,通过无页面刷新实现代码更新
    ...
    //该插件处理html页面,并按照配置引入编译后的js 以及CSS。chunk参数如不写,则默认把所有的output;内输出的JS文件全部引入
    new HtmlWebpackPlugin({
      filename: 'index.html', //输出的入口html的名称
      template: 'index.html', //源入口html文件
      inject: true,
      chunks: ['app']
    }),
    // 自动复制指定文件到指定文件夹

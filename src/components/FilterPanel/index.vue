<template>
  <div class="filter-container">
    <el-form
      :inline="filterConfig.inline"
      :label-width="filterConfig.labelWidth"
      :label-position="filterConfig.labelPosition">
      <el-row :gutter="filterConfig.gutter">
        ...
        >
          <el-form-item
            :label="item.label"
            :prop="item.prop"
            :label-width="item.labelWidth?item.labelWidth:(filterConfig.labelWidth?filterConfig.labelWidth:'80px')">
        ...
        <el-col :span="filterConfig.operateCol ? filterConfig.operateCol : filterConfig.col">
          <el-form-item>
            <div class="operate-area">
              <el-button
                v-for="(item,index) in filterConfig.operates"
                :key="index"
                :type="item.type"
                :size="item.size"
                :disabled="item.disabled"
